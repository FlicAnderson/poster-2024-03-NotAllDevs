...
\newcommand{\subtitle}{Are YOU RS-10X? Mining GitHub Data to Describe Developer/Repository Interaction Types}
...
\block{0: Conclusions}{
    ...
    \setlength\itemsep{0.2em}
        ...
        \item These metrics have limitations, but in combination with other properties may give a fuller picture of development responsibility or activity.
        \item \textbf{Can this approach locate distinct clusters of behaviours and define and describe RS developer personas? } 
    \end{itemize}
    \vspace{1em}
    }
    {\fontsize{45}{45}\selectfont
