...
\block[linewidth=5pt]{1: Mining RS Repository Data To Understand Dev/Repo Interactions}{
    ...
    {\fontsize{40}{40}\selectfont 
        ...
        Data for public GitHub projects with a DOI (often required for publication) across all fields have been used, with inclusion/exclusion criteria.
        \begin{tikzfigure}[]
...
\block[linewidth=5pt]{2: More Responsibility = More Action?}{
    ...
    %Amongst those who do, assignment of issues are not frequent.  
