...
\author{\textbf{Felicity `Flic' Anderson\textsuperscript{$\dagger$}}}
...
\block[linewidth=3pt]{}{
    ...
    \textbf{Supervised by:} Dr. Julien Sindt\textsuperscript{$\dagger$} \& Prof. Neil Chue Hong\textsuperscript{$\dagger$}. \newline
