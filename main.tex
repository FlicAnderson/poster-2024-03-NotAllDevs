...
\block{3: Results}{
    ...
    \vspace*{0.4em} \newline
    \textbf{Assignment Practices} \newline Nam venenatis viverra urna eget bibendum. Aliquam vel pellentesque odio. Aliquam a ornare mauris, sed volutpat nisl. Nunc justo odio, facilisis quis gravida nec, tincidunt non erat. Nunc ultricies dictum lobortis. Donec nulla nunc, fermentum et pulvinar vel, ultricies quis purus.\newline
    \vspace*{0.4em} \newline
    ...
    \vspace*{0.4em} \newline
    \textbf{Developer Interaction Types} \newline  Suspendisse porta, metus vel eleifend molestie, tortor justo pulvinar nulla, vel volutpat nulla nulla vitae nulla. Donec tristique lacinia rutrum.  Aenean dui mi, aliquam nec elit egestas. 
    }
    \end{multicols}
}
